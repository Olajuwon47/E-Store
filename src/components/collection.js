          ...
          <div>
            <div className="mt-10">
              ...
              <div
                ...
                className="pointer-events-none lg:absolute lg:inset-y-0 lg:mx-auto lg:w-full lg:max-w-7xl"
              >
                <div className="absolute transform sm:left-1/2 sm:translate-x-8 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 lg:translate-x-8">
                  <div className="flex items-center space-x-6 lg:space-x-8">
                      ...
                      <div key={columnIndex} className="grid shrink-0 grid-cols-1 gap-y-6 lg:gap-y-8">
                        {[...Array(3)].map((_, rowIndex) => (
                          ...
                          >
                            <img
                              alt="Summer Style"
                              src={`https://tailwindui.com/plus/img/ecommerce-images/home-page-03-hero-image-tile-0${rowIndex + 1}.jpg`}
