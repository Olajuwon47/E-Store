...
export default function Newletter() {
  return (
    <div className="relative isolate overflow-hidden bg-lime-400 py-16 sm:py-24 lg:py-32">
        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <button
                type="submit"
                className="flex-none rounded-md bg-green-700 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-lime-700"
              >
                Subscribe
              </button>
            </div>
